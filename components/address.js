...
const Checkout = () => {
  const { toggleCart, address, setDefault, DeleteAds } = useGlobalState()
        ...
        {address.length !== 0 ?
          <>
            <div className="flex flex-col sm:flex-row justify-between">
              ...
              <div className="flex items-center justify-between space-x-4">
                ...
                <button className="bg-white text-purple-500 border border-purple-500 py-2 px-6 rounded w-fit hover:bg-purple-950" onClick={() => toggleCart(changeBtn)}>Change</button>
              </div>
            </div>
            <div ref={changeBtn} className='hidden'>
              <div className="flex justify-start flex-col items-center min-[490px]:flex-row flex-wrap">
                ...
                <div className="bg-purple-400 rounded-md w-fit p-4 m-2 flex items-center flex-col">
                  <button className="font-bold text-black" onClick={() => toggleCart(addBtn)}>Add New Address</button>
                </div>
              </div>
              <div className="hidden" ref={addBtn}>
                <AddData updatetext={editText} />
              </div>
            </div>
          ...
          <>
            <div className="flex justify-between">
              ...
              <button className="bg-purple-500 text-white py-2 px-6 rounded w-fit hover:bg-purple-950" onClick={() => toggleCart(addBtn)}>Add</button>
            </div>
            <div className="hidden" ref={addBtn}>
              <AddData />
            </div>
