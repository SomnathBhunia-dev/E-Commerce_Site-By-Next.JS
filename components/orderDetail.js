                    ...
                    <div className="bg-white shadow-lg rounded-lg px-6 py-8">
                        <div className='flex justify-between flex-col md:flex-row'>
                            <div className="mb-6">
                                ...
                                {RecentOrder?.Order_address &&
                                    <p className="text-gray-600 mb-1">
                                        <span className="font-semibold text-purple-600">Name: {RecentOrder?.Order_address.firstName} {RecentOrder?.Order_address.lastName}</span>
                                    </p>}
                                {RecentOrder?.Order_address &&
                                    <div className="text-gray-600 mb-1">
                                        <span className="font-bold text-gray-800">
                                            <p> Address: {RecentOrder?.Order_address.road}, </p>
                                            <p>{RecentOrder?.Order_address.District}, {RecentOrder?.Order_address.State} - {RecentOrder?.Order_address.Pin}</p>
                                        </span>
                                    </div>}
                            </div>
                            <div className="w-80">
                                ...
                                <ol role="list" className="my-6 divide-y divide-gray-200 mr-4">
                                    {RecentOrder?.item && RecentOrder?.item.map((i) => (
